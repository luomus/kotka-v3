...
import { ApiService, DataType } from './api.service';
...
export class DatatableDataService {
  ...
  getData(dataType: DataType, startRow: number, endRow: number, sortModel: SortModel[], filterModel: any): Observable<ListResponse<Dataset>> {
